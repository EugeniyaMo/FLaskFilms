...
class AddFilmForm(FlaskForm):
    ...
    rating = IntegerField('Рейтинг кинокритиков', validators=[DataRequired()])
...
class SearchYearForm(FlaskForm):
    ...
    start_year = IntegerField('Минимальный год', validators=[DataRequired()], default=1895)
    end_year = IntegerField('Максимальный год', validators=[DataRequired()], default=2100)
